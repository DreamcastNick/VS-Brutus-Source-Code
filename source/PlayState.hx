...
class PlayState extends MusicBeatState
{
	...
	override public function create()
	{
		...
		switch (songLowercase)
		{
			...
			case 'pootus':
				dialogue = CoolUtil.coolTextFile(Paths.txt('pootus/pootusdialouge'));
			case 'mc-hearthead':
				dialogue = CoolUtil.coolTextFile(Paths.txt('mc-hearthead/mc-heartheadDialouge'));
			case 'brutus-of-the-troy':
				dialogue = CoolUtil.coolTextFile(Paths.txt('brutus-of-the-troy/brutus-of-the-troyDialouge'));
			case 'omega-blubber-flubber':
				dialogue = CoolUtil.coolTextFile(Paths.txt('omega-blubber-flubber/omega-blubber-flubberDialouge'));
			case 'crooked-eyed-millie':
				dialogue = CoolUtil.coolTextFile(Paths.txt('crooked-eyed-millie/crooked-eyed-milliedialouge'));
			case 'folksong':
				dialogue = CoolUtil.coolTextFile(Paths.txt('folksong/folksongdialouge'));
			case 'second-shittie-sister':
				dialogue = CoolUtil.coolTextFile(Paths.txt('second-shittie-sister/second-shittie-sisterdialouge'));
			case 'omega-rascal-snapple':
				dialogue = CoolUtil.coolTextFile(Paths.txt('omega-rascal-snapple/omega-rascal-snappledialouge'));
			case 'chewtoy':
				dialogue = CoolUtil.coolTextFile(Paths.txt('chewtoy/chewtoydialouge'));
			case 'tutorial':
				dialogue = CoolUtil.coolTextFile(Paths.txt('tutorial/tutorialdialouge'));
				
			case 'pootus':
				curStage = 'brutusinterior';
				var bg:FlxSprite = new FlxSprite(-100).loadGraphic(Paths.image('Brutus/bg'));
				var bgDoggies:FlxSprite = new FlxSprite(-240, 200);
				var hallowTex = Paths.getSparrowAtlas('BGDoggies','Brutus');
				bgDoggies.frames = Paths.getSparrowAtlas('Brutus/BGDoggies');
				bgDoggies.animation.addByPrefix('idle',"BGDoggies Bounce", 12);
				bgDoggies.animation.play('idle', true);
				bgDoggies.scrollFactor.set(0.85, 0.85);
				bgDoggies.updateHitbox();
				add(bg);
				add(bgDoggies);
			...
			case 'rng':
				curStage = 'brutusrng';
				var bg:FlxSprite = new FlxSprite(-100).loadGraphic(Paths.image('Brutus/rngbg'));
				var bgDoggies:FlxSprite = new FlxSprite(-240, 200);
				var hallowTex = Paths.getSparrowAtlas('BG-Doggies-Pixel','Brutus');
				bgDoggies.frames = Paths.getSparrowAtlas('Brutus/BG-Doggies-Pixel');
				bgDoggies.animation.addByPrefix('idle',"BG-Doggies-Pixel Dance", 12);
				bgDoggies.animation.play('idle', true);
				bgDoggies.scrollFactor.set(0.85, 0.85);
				bgDoggies.updateHitbox();
				add(bg);
			...
			case 'brutus-of-the-troy':
				curStage = 'brutusinteriorevil';
				var bg:FlxSprite = new FlxSprite( -100).loadGraphic(Paths.image('Brutus/bgevil'));
				add(bg);
				bg.scrollFactor.set(0.1, 0.1);
				bg.active = false;
				bg.updateHitbox();
			...
			case 'omega-blubber-flubber':
				curStage = 'brutusinteriorfinal';
				var bg:FlxSprite = new FlxSprite( -100).loadGraphic(Paths.image('Brutus/finalbg'));
				add(bg);
				bg.scrollFactor.set(0.1, 0.1);
				bg.active = false;
				bg.updateHitbox();
			...
			case 'second-shittie-sister':
				curStage = 'brutusinteriorfinal2';
				var bg:FlxSprite = new FlxSprite(-100).loadGraphic(Paths.image('Brutus/finalbg2'));
				add(bg);
				bg.scrollFactor.set(0.1, 0.1);
				bg.active = false;
				bg.updateHitbox();
			...
			case 'omega-rascal-snapple':
				curStage = 'brutusinteriorfinal3';
				var bg:FlxSprite = new FlxSprite(-100).loadGraphic(Paths.image('Brutus/finalbg3'));
				add(bg);
				bg.scrollFactor.set(0.1, 0.1);
				bg.active = false;
				bg.updateHitbox();
			...
			case 'lil-pup':
				curStage = 'brutuspark';
				var bg:FlxSprite = new FlxSprite(-100).loadGraphic(Paths.image('Brutus/parkbg'));
				add(bg);
				bg.scrollFactor.set(0.1, 0.1);
				bg.active = false;
				bg.updateHitbox();
		...
		switch (SONG.player2)
		{
			...
			case 'omega-brutus':
				...
				dad.y += 350;
				camPos.set(dad.getGraphicMidpoint().x + 300, dad.getGraphicMidpoint().y);
				FlxTween.tween(dad, {x: 428, y: 700}, 2.5, {type : FlxTweenType.PINGPONG, ease: FlxEase.quadInOut, loopDelay: 0});
			case 'millie-normal':
				dad.x -= 100;
				dad.y += 410;
				camPos.set(dad.getGraphicMidpoint().x + 300, dad.getGraphicMidpoint().y);
			case 'millie-sss':
				...
				dad.y -= 100;
				camPos.set(dad.getGraphicMidpoint().x + 300, dad.getGraphicMidpoint().y);
				FlxTween.tween(dad, {x: 0, y: 50}, 0.25, {type : FlxTweenType.PINGPONG, ease: FlxEase.quadInOut, loopDelay: 0});
			case 'rascal-normal':
				dad.x -= 100;
				dad.y += 300;
				camPos.set(dad.getGraphicMidpoint().x + 300, dad.getGraphicMidpoint().y);
			...
			case 'lil-puppy':
				dad.x -= 100;
				dad.y += 480;
				camPos.set(dad.getGraphicMidpoint().x + 520, dad.getGraphicMidpoint().y);
			case 'brutus-pixel':
				dad.x += 100;
				dad.y += 250;
				camPos.set(dad.getGraphicMidpoint().x + 300, dad.getGraphicMidpoint().y);
		...
		switch (curStage)
		{
			...
			case 'brutuspark':
				...
				gf.x += 250;
				gf.y += 80;
				camPos.set(dad.getGraphicMidpoint().x + 520, boyfriend.getGraphicMidpoint().y);
